#include "include/codemelted_flutter/codemelted_flutter_plugin.h"
...
#include "codemelted_flutter_plugin_private.h"
...
static void codemelted_flutter_plugin_dispose(GObject* object) {
